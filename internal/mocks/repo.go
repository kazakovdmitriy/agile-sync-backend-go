...
//
//	mockgen -source=internal/repository/interfaces.go -destination=internal/mocks/repo.go -package=mocks
//
...
func (m *MockVoteRepository) SetVoteValue(ctx context.Context, sessionID, userID uuid.UUID, vote string) error {
	m.ctrl.T.Helper()
