...
type EventHandler interface {
	Handle(conn *websocket.Conn, data map[string]interface{}) error
...
func (s *WebSocketService) HandleMessage(conn *websocket.Conn, data map[string]interface{}) error {
	...
	return handler.Handle(conn, data)
}
